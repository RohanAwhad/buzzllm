use crate::providers::{AnthropicClient, LlmClient, ToolSchemaFormat};
        ...
        "content_block_start" => {
            ...
            if content_block.get("type").and_then(|v| v.as_str()) == Some("tool_use") {
                ...
                *current_tool_call_id = tool_id.to_string();
                tool_calls.insert(tool_id.to_string(), ToolCallData::new(tool_id, tool_name));
